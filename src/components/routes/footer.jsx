    ...
    <div className="card text-center footer1">
      <div className="card-body">
        <button type="button" className="btn btn-xl bg-new5 ">
          <a target="_blank" href="https://www.facebook.com/niroggyan/">
        ...
        <button type="button" className="btn btn-xl bg-new7">
          <a target="_blank" href="https://medium.com/@niroggyan_smart_reports">
            <div className="form-group navIcon">
        ...
        <button type="button" className="btn btn-xl bg-new6">
          <a
            target="_blank"
            href="https://www.instagram.com/niroggyan_reports/?hl=en"
          >
            <div className="form-group navIcon ">
        ...
        <button type="button" className="btn btn-xl bg-new4">
          <a target="_blank" href="https://www.linkedin.com/company/niroggyan">
            <div className="form-group navIcon ">
      ...
      <div className="card-footer text-muted footer2">
        <p className="changecolor">
          Copyright 2020 © NirogGyan All rights reserved | Privacy Policy |
          Terms & Conditions
        </p>
      </div>
    </div>
