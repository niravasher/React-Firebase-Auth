          ...
          <div className="row text-center human_body">
            ...
            <div class="col-lg-12">
              <div>
                ...
                {this.state.nodeInnerText === "Kidney" && (
                  <p class="card-text">Kidney tests measure levels of various substances in the blood to determine the current health of your kidneys, including:-<br> 
                   • minerals, <br>
                   • electrolytes, <br>
                   • proteins, and <br>
                   • glucose (sugar).<br>
                ...
                {this.state.nodeInnerText === "Lipids" && (
                  <p class="card-text">Lipid tests are a combination of test primarily to check for coronary heart disease, they measure:- <br> 
                ...
                {this.state.nodeInnerText === "Thyroid" && (
                  <p class="card-text">Thyroid test is conducted to measure the function of the thyroid gland via a blood sample. The test measures values of:-<br> 
                   • Thyroxine (T4), <br>
                ...
                {this.state.nodeInnerText === "Liver" && (
                  <p class="card-text">TLiver function test is used to ascertain the functioning of a person’s liver. The test measures parameters such as:- <br>
                   • Total Protein, <br>
                   • Albumin, <br>
                   • Globulin, <br>
                   • A/G Ratio, <br>
                ...
                {this.state.nodeInnerText === "Diabetes" && (
                  <p class="card-text">HbA1c is a blood test that estimates the 90-day average blood glucose levels. HbA1c provides a longer-term trend on the blood sugar levels over a period of time. The test includes:- <br>
                   • HbA1c% <br>
                   • Fetal Hemoglobin <br>
                ...
                {this.state.nodeInnerText === "Electrolytes & Minerals" && (
                  <p class="card-text">An electrolyte panel is a blood test that measures the levels of electrolytes and carbon dioxide in your blood. Electrolytes measured are:-<br>
                   • Calcium<br>
                   • Sodium<br>
                   • Potassium<br>
                   • Chloride<br>
                ...
                {this.state.nodeInnerText === "Urine" && (
                  <p class="card-text">Urine test may be used to identify UTIs, kidney, metabolic and other disorders. The test gives parameters such as:- <br>
                   • RBCs Urine, <br>
                   • Colour, <br>
                   • Epithelial Cell, <br>
                   • Urobilinogen, <br>
